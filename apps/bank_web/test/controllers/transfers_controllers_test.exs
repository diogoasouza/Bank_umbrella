defmodule BankWeb.TransfersControllerTest do
  ...
  test "renders the create transfer page with an error flash when not all fields where filled", %{
    conn: conn
  } do
    conn =
      conn
  ...
  test "renders the create transfer page with an error when the receiver is invalid", %{
    conn: conn
  } do
    conn =
      conn
  ...
  test "renders the create transfer page with an error when both currencies dont match", %{
    conn: conn
  } do
    conn =
      conn
  ...
  test "renders the create transfer split page with an error flash when not all fields where filled",
       %{conn: conn} do
    conn =
      conn
      |> assign(:user_id, "1")
  ...
  test "renders the create transfer split page with an error flash when there isnt enough balance",
       %{conn: conn} do
    conn =
      conn
      |> assign(:user_id, "1")
  ...
  test "renders the create transfer split page with an error flash when one of the receivers is invalid",
       %{conn: conn} do
    conn =
      conn
      |> assign(:user_id, "1")
  ...
  test "renders the create transfer split page with an error flash when the currencies dont match",
       %{conn: conn} do
    conn =
      conn
      |> assign(:user_id, "1")
